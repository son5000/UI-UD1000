(function ($) {
    ...
    $.fn.dateTimePicker = function (options) {
        ...
        var settings = $.extend({
            ...
            buttonTitle: "Select",
            updateDateTime: this.updateDate
        }, options);
        ...
        return this.each(function () {
            ...
            // hangubi elem.addClass("dtp_main");
            // hangubi updateMainElemGlobal();
            ...
            elem.on('click', function () {
                ...
                function changeDate() {
                    ...
                    lastSelected = copyDate(selectDate);
                    // hangubi settings.updateDateTime(selectDate);
                ...
                function close() {
                    ...
                    settings.updateDateTime(selectDate);
                    $content.remove();
                    $win.remove();
                }
                ...
                function updateDate() {
                    ...
                    // hangubi updateMainElem();
                    // hangubi elem.next().val(selectDate.format(settings.dateFormat));
                    if (!settings.showTime) {
                        $content.remove();
                        $win.remove();
                    }
